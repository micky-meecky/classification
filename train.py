...
if __name__ == '__main__':
    ...
    # test_precision, test_recall, test_f1_score, test_acc = \
    #     Train_breast('Transunet_cls_seg_BUSI_ch3_256_01', 6, 800, 'Transunet', 6e-4,
    #                  Use_pretrained=False,
    #                  _have_segtask=True,
    #                  _only_segtask=False,
    #                  is_continue_train=False,
    ...
    test_precision, test_recall, test_f1_score, test_acc = \
        Train_breast('AgUnet_cls_seg_ch3_256_00', 6, 800, 'agunet', 6e-4,
                     Use_pretrained=False,
                     _have_segtask=True,
                     _only_segtask=False,
                     is_continue_train=False,
    ...
    test_precision, test_recall, test_f1_score, test_acc = \
        Train_breast('AgconvUnet_cls_seg_ch3_256_00', 6, 800, 'agconvunet', 6e-4,
                     Use_pretrained=False,
                     _have_segtask=True,
                     _only_segtask=False,
                     is_continue_train=False,
